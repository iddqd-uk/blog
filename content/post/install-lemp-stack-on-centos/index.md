...
О том как это сделать ты можешь прочитать по [этой ссылке]({{< ref "compile-and-config-msmtp" >}}). Не забудь внести соответствующие изменения в `/etc/php.ini` при их наличии.
